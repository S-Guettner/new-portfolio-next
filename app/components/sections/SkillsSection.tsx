        ...
        <main className='relative'>
            <section className='text-white absolute pt-3'>
                <section className='p-4 pb-0 mb-4 '>
                    ...
                    <p className='text-green pl-4'>&lt;Technologies&gt;</p>
                    <div className='text-text '>
                        <div className='flex justify-evenly w-3/4 gap-x-9 gap-y-3 mx-auto flex-wrap pt-5 mb-3 text-textLarge'>
                            {/* HTML5 */}
                            <div className={`flex flex-col w-10 h-20 justify-center items-center ${languageAnimation}`}>
                    ...
                    <p className='text-green pl-6 '>&lt;/Technologies&gt;</p>
