                ...
                <section className='p-4 pb-0 mb-4 '>
                    ...
                    <div className='text-text '>
                        <div className='flex justify-evenly w-3/4 gap-x-9 gap-y-3 mx-auto flex-wrap pt-5 mb-3 text-textLarge md:gap-y-10 md:py-10'>
                            {/* HTML5 */}
                            <div className={`flex flex-col w-10 h-20 justify-center items-center ${languageAnimation} md:w-28 `}>
                    ...
                    <section className='pl-6'>
                        <p className='text-green md:text-lg'>&lt;p&gt;</p>
                        <p className='text-text mb-2 md:text-[1.5rem]'>Venturing deep into the world of modern web development, I harness the reactive power of React, the server-side magic of Next.js, and the strong-typing benefits of TypeScript.</p>
                        <p className='text-text mb-2 md:text-[1.5rem]'>MongoDB enables precision in my data management. My designs are elevated with the utility-first charm of Tailwind ❤️.</p>
                        <p className='text-green md:text-lg'>&lt;/p&gt;</p>
                    </section>
